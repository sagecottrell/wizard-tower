...
public static partial class TransportEvents {    
    ...
    public static bool TryDestroying(TransportDestroyingEvent pre, [NotNullWhen(true)] out TransportDestroyedEvent? e) {
        e = null;
    ...
    public static bool TryConstructing(TransportConstructingEvent pre, [NotNullWhen(true)] out TransportConstructedEvent? e) {
        e = null;
