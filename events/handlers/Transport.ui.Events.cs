...
public static partial class TransportEvents {
    public static partial class Ui {        
        ...
        public static bool TryConstructionPreviewStarting(TransportConstructionPreviewStartingEvent pre, [NotNullWhen(true)] out TransportConstructionPreviewStartedEvent? e) {
            e = null;
            if (OnConstructionPreviewStarting(pre).IsAllowed) {
                e = pre.Into();
                return true;
            }
            return false;
        }        
        public static bool TryConstructionPreviewStopping(TransportConstructionPreviewStoppingEvent pre, [NotNullWhen(true)] out TransportConstructionPreviewStoppedEvent? e) {
            e = null;
        ...
        public static bool TryConstructionStopping(TransportConstructionStoppingEvent pre, [NotNullWhen(true)] out TransportConstructionStoppedEvent? e) {
            e = null;
        ...
        public static bool TryConstructionSelecting(TransportConstructionSelectingEvent pre, [NotNullWhen(true)] out TransportConstructionSelectedEvent? e) {
            e = null;
        ...
        public static bool TrySelecting(TransportSelectingEvent pre, [NotNullWhen(true)] out TransportSelectedEvent? e) {
            e = null;
            if (OnSelecting(pre).IsAllowed) {
                e = pre.Into();
                return true;
            }
            return false;
        }        
        public static bool TryDeselecting(TransportDeselectingEvent pre, [NotNullWhen(true)] out TransportDeselectedEvent? e) {
            e = null;
            if (OnDeselecting(pre).IsAllowed) {
                e = pre.Into();
                return true;
            }
            return false;
